...
public class TimeTableTwoRequestDto {
    ...
    private List<timetableSubjectRequestDtoList> timetableSubjectRequestDtoList;

    public void setTimetableSubjectRequestDtoList(List<timetableSubjectRequestDtoList> timetableSubjectRequestDtoList) {
        this.timetableSubjectRequestDtoList = timetableSubjectRequestDtoList;
    }


    public static class timetableSubjectRequestDtoList {
