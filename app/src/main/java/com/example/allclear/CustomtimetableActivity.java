...
import com.example.allclear.databinding.ActivityCustomtimetableBinding;
...
public class CustomtimetableActivity extends AppCompatActivity {
    private ActivityCustomtimetableBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding=ActivityCustomtimetableBinding.inflate(getLayoutInflater());
